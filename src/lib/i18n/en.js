export const T = {
  ...
  booker: {
    ...
    whatIsBody: 'One page an artist shares with you before you book them — real nights, checked and dated. Crowd size always shows as a range, never a made-up exact number or a score.',
    whatIsPoints: [
      'Every claim says plainly how it was checked',
      'Crowd size as a range, facts as yes/no — never a ranking, never a prediction',
  ...
  admin: {
    ...
    sec01Items: [
      "Data access is locked per organization — nobody sees another act's evidence.",
      'No score, percentage, ranking, or raw number shows anywhere.',
      'A public Passport is a fixed, signed snapshot — private fields stay private.',
      'Evidence stays private; every consent is logged by what it covers.',
      'Every destructive action is written to the audit trail.',
    ],
  ...
  actEditor: {
    ...
    formatOptions: {
      'dj-set': 'DJ set',
      'live-set': 'Live electronic set',
      duo: 'Duo',
      band: 'Band',
      'open-format': 'Open format',
      vocalist: 'Vocalist / original artist',
      other: 'Other',
    },
    actsLabel: 'Your acts',
    untitledAct: 'Untitled act',
    accessCardTitle: 'Who can act for you',
    accessCardBody: 'Let a manager you trust help with date requests — you decide what they can do, and you can end it anytime.',
    accessCardCta: 'Manage access',
  },
  errors: {
