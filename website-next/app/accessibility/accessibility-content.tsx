...
const content: LegalContent = {
    ...
    sections: [
      {
        ...
        paragraphs: [
          'GIGPROOF פועל להנגיש את השירות לכלל המשתמשים, לרבות אנשים עם מוגבלות, בהתאם לתקנות שוויון זכויות לאנשים עם מוגבלות (התאמות נגישות לשירות), התשע״ג-2013, ולתקן הישראלי ת״י 5568 ברמה AA.',
        ],
      },
      {
  ...
  en: {
    ...
    title: 'Accessibility Statement — GIGPROOF',
    ...
    sections: [
      {
        ...
        paragraphs: [
          'GIGPROOF is working to make the service accessible to all users, including people with disabilities, in accordance with the Equal Rights for Persons with Disabilities Regulations (Service Accessibility Adjustments), 5773-2013, and Israeli Standard SI 5568, Level AA.',
        ],
      },
      {
