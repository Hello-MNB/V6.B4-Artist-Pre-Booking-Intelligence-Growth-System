    ...
    sections: [
      {
        heading: '1. השירות',
        paragraphs: [
          'GIGPROOF מספק תצוגת-ראיות מתויגת-שיטה לגבי אמנים ("Passport" ציבורי לקונה; "Mirror" פרטי לאמן), לצורך הפחתת-סיכון בהחלטות הזמנה.',
        ],
      },
      {
        heading: '2. ⚠️ הבהרה מהותית — אין ציון, אין דירוג, אין הבטחה',
        paragraphs: [
