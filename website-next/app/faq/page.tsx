  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'A booking manager (אמרגן) is the person who evaluates artists for events and takes reputational risk if a booking goes wrong. They receive Passport links, open them in a browser, and decide. LOCK is free for booking managers — no account required to view a Passport.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'A magic link is a unique, bounded URL generated by LOCK for a specific gig. The artist sends it to the producer via WhatsApp, SMS, or email. The link shows only that gig record. The producer can confirm, flag, or decline. The link expires after use and cannot be re-used to access other data.',
      },
      {
      ...
      },
      {
        ...
        a: 'During the current beta period, LOCK operators (the founding team) review submitted documents manually and assign method labels. Automated extraction is not yet active.',
      },
      {
