      ...
      <section style={{ padding: '64px 24px 80px' }}>
        <div style={{
          ...
          <div>
            ...
            {/* Static form — will be wired to Formspree or similar before launch */}
            <form
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                ...
                >
                  ...
                  <option value="booker">Booking Manager / אמרגן</option>
