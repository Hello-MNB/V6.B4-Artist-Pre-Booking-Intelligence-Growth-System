...
| M-18 | **CLAUDE.md pointer to the build method** | Approve one line for CLAUDE.md (your file — I don't edit it): "TASK METHOD: every task follows docs/HOW-TO-BUILD-A-TASK.md — decomposition + the L0–L5 self-verify ladder; fit-defects are the builder's job." | Makes the method survive any future session/agent from the first read |
